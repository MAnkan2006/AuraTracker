  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div 
        ...
        className="relative w-full max-w-lg group-data-[scheme=light]:!bg-white backdrop-blur-2xl border border-white/20 group-data-[scheme=light]:border-gray-200 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] group-data-[scheme=light]:shadow-2xl transform transition-all flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200"
      >
