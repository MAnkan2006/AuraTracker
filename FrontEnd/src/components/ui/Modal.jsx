  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      <div 
        ...
        onClick={onClose}
      ></div>
      <div className="relative w-full max-w-lg bg-[var(--card-bg)] backdrop-blur-xl border border-white/10 group-data-[scheme=light]:border-black/[0.08] group-data-[scheme=light]:bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.4)] group-data-[scheme=light]:shadow-2xl transform transition-all flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
